.PHONY: default build install uninstall reinstall test test-all test-sigalt-freevar clean smt2 doc
...
YICES2_ENABLE_MCSAT ?= 1
YICES2_ENABLE_DELEGATES ?= 1
YICES2_WITHOUT_DELEGATES ?=
YICES2_SMT2_STATIC ?= 0

DUNE_ENV = YICES2_FORCE_LOCAL=$(YICES2_FORCE_LOCAL) \
           YICES2_ENABLE_MCSAT=$(YICES2_ENABLE_MCSAT) \
           YICES2_ENABLE_DELEGATES=$(YICES2_ENABLE_DELEGATES) \
           YICES2_WITHOUT_DELEGATES="$(YICES2_WITHOUT_DELEGATES)" \
