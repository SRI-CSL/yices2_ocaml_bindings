...
module Make(EH: ErrorHandling) : sig
  ...
  module Type : sig
    ...
    val reveal : type_t -> ytype EH.t
    val build  : ytype -> type_t EH.t
  ...
  module Model : sig
    ...
    val collect_defined_terms : model_t ptr -> term_t list EH.t
    ...
    *)
    ...
    val generalize_model : model_t ptr -> term_t -> term_t list -> yices_gen_mode -> term_t list EH.t

    (** Compute a generalization of mdl for the conjunct (a[0] /\ ... /\ a[n-1])  *)
    val generalize_model_array : model_t ptr -> term_t list -> term_t list -> yices_gen_mode -> term_t list EH.t
  ...
  module Context : sig
    ...
    val get_unsat_core : context_t ptr -> term_t list EH.t
  ...
  module PP : sig
    ...
    (** Pretty printing:
        ...
        On error:
         ...
         in this case, errno, perror, etc. can be used for diagnostic.  *)
    val model_file :
      FILE.t ptr -> ?width:int -> ?height:int -> ?offset:int -> model_t ptr -> unit EH.t
