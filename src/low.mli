...
module API : sig
  ...
  val yices_version : char ptr ptr
  ...
  val yices_build_arch : char ptr ptr
  val yices_build_mode : char ptr ptr
  val yices_build_date : char ptr ptr
   ...
   * yices_free_string. *)
  val yices_error_string : unit -> char ptr
  ...
  val yices_bool_type : unit -> type_t
  val yices_int_type  : unit -> type_t
  val yices_real_type : unit -> type_t
   ...
   *   code = POS_INT_REQUIRED
   *   badval = size *)
  val yices_new_scalar_type : uint -> type_t

  (* New uninterpreted type. No error report. *)
  val yices_new_uninterpreted_type : unit -> type_t
   ...
   *   code = INVALID_TYPE
   *   type1 = tau[i] *)
  val yices_tuple_type : uint -> type_t ptr -> type_t
  ...
  val yices_tuple_type1 : type_t -> type_t
  val yices_tuple_type2 : type_t -> type_t -> type_t
  val yices_tuple_type3 : type_t -> type_t -> type_t -> type_t
   ...
   *   code = INVALID_TYPE
   *   type1 = dom[i] *)
  val yices_function_type : uint -> type_t ptr -> type_t -> type_t
  ...
  val yices_function_type1 : type_t -> type_t -> type_t
  val yices_function_type2 : type_t -> type_t -> type_t -> type_t
  val yices_function_type3 : type_t -> type_t -> type_t -> type_t -> type_t
   ...
   *    type1 = tau *)
  val yices_bvtype_size : type_t -> uint
  ...
  val yices_scalar_type_card : type_t -> uint
   ...
   *   code = INVALID_TYPE
   *   type1 = tau *)
  val yices_type_num_children : type_t -> sint
   ...
   *   code = INVALID_TYPE_OP *)
  val yices_type_child : type_t -> sint -> type_t
   ...
   *   type1 = tau
   *   badval = index *)
  val yices_constant : type_t -> sint -> term_t
   ...
   *   code = INVALID_TYPE
   *   type1 = tau *)
  val yices_new_uninterpreted_term : type_t -> term_t
   ...
   *   code = INVALID_TYPE
   *   type1 = tau *)
  val yices_new_variable : type_t -> term_t
   ...
   *   term1 = arg[i]
   *   type1 = expected type *)
  val yices_application : term_t -> uint -> term_t ptr -> term_t
  ...
  val yices_application1 : term_t -> term_t -> term_t
  val yices_application2 : term_t -> term_t -> term_t -> term_t
  val yices_application3 : term_t -> term_t -> term_t -> term_t -> term_t
   ...
   *   term2 = else_term
   *   type2 = term2's type *)
  val yices_ite : term_t -> term_t -> term_t -> term_t
   ...
   *   term2 = right
   *   type2 = term2's type *)
  val yices_eq : term_t -> term_t -> term_t
  val yices_neq : term_t -> term_t -> term_t
   ...
   *   term1 = arg[i]
   *   type1 = bool (expected type) *)
  val yices_or : uint -> term_t ptr -> term_t
  val yices_and : uint -> term_t ptr -> term_t
  val yices_xor : uint -> term_t ptr -> term_t

  (* Variants of or/and/xor with 2 or 3 arguments *)
  val yices_or2 : term_t -> term_t -> term_t
  val yices_and2 : term_t -> term_t -> term_t
  val yices_xor2 : term_t -> term_t -> term_t
  val yices_or3 : term_t -> term_t -> term_t -> term_t
  val yices_and3 : term_t -> term_t -> term_t -> term_t
  val yices_xor3 : term_t -> term_t -> term_t -> term_t
   ...
   *    term1 = left/right
   *    type1 = bool (expected type) *)
  val yices_iff : term_t -> term_t -> term_t
  val yices_implies : term_t -> term_t -> term_t
   ...
   *   code = INVALID_TERM
   *   term1 = arg[i] *)
  val yices_tuple : uint -> term_t ptr -> term_t

  (* Variants for n=2 or n=3
   * - same error reports as yices_tuple if arg1, arg2, or arg3 is invalid *)
  val yices_pair : term_t -> term_t -> term_t
  val yices_triple : term_t -> term_t -> term_t -> term_t
   ...
   *    type1 = type of tuple
   *    badval = index *)
  val yices_select : uint -> term_t -> term_t
  ...
  val yices_tuple_update : term_t -> uint -> term_t -> term_t
   ...
   *    term1 = arg[i]
   *    type1 = expected type *)
  val yices_update : term_t -> uint -> term_t ptr -> term_t -> term_t
  ...
  val yices_update1 : term_t -> term_t -> term_t -> term_t
  val yices_update2 : term_t -> term_t -> term_t -> term_t -> term_t
  val yices_update3 : term_t -> term_t -> term_t -> term_t -> term_t -> term_t
   ...
   *    term2 = arg[j]
   *    type2 = term2's type *)
  val yices_distinct : uint -> term_t ptr -> term_t
   ...
   *    term1 = var[i] *)
  val yices_forall : uint -> term_t ptr -> term_t -> term_t
  val yices_exists : uint -> term_t ptr -> term_t -> term_t
   ...
   *    term1 = var[i]
   * *)
  val yices_lambda : uint -> term_t ptr -> term_t -> term_t
  ...
  (* Zero: no error *)
  val yices_zero : unit -> term_t

  (* Integer constants *)
  val yices_int32 : sint -> term_t
  val yices_int64 : long -> term_t
  ...
  val yices_rational32 : sint -> uint -> term_t
  val yices_rational64 : long -> ulong -> term_t
  ...
  val yices_parse_rational : char ptr -> term_t
  ...
  val yices_parse_float : char ptr -> term_t
  ...
  val yices_add : term_t -> term_t -> term_t
  val yices_sub : term_t -> term_t -> term_t
  val yices_neg : term_t -> term_t
  val yices_mul : term_t -> term_t -> term_t
  val yices_square : term_t -> term_t
  val yices_power : term_t -> uint -> term_t
   ...
   *   code = ARITHTERM_REQUIRED
   *   term1 = t[i] *)
  val yices_sum : uint -> term_t ptr -> term_t
   ...
   *   badval = degree *)
  val yices_product : uint -> term_t ptr -> term_t
   ...
   *    code = ARITHTERM_REQUIRED
   *    term1 = t1 or t2 *)
  val yices_division : term_t -> term_t -> term_t
   ...
   *    code = ARITHTERM_REQUIRED
   *    term1 = t1 or t2 *)
  val yices_idiv : term_t -> term_t -> term_t
  val yices_imod : term_t -> term_t -> term_t
   ...
   *    term1 = t2 *)
  val yices_divides_atom : term_t -> term_t -> term_t
   ...
   *    term1 = t
   * *)
  val yices_is_int_atom : term_t -> term_t
   ...
   *    code = ARITHTERM_REQUIRED
   *    term1 = t *)
  val yices_abs : term_t -> term_t
  val yices_floor : term_t -> term_t
  val yices_ceil : term_t -> term_t
  ...
  val yices_poly_int32 : uint -> sint ptr -> term_t ptr -> term_t
  val yices_poly_int64 : uint -> long ptr -> term_t ptr -> term_t
   ...
   * if den[i] is 0
   *   code = DIVISION_BY_ZERO *)
  val yices_poly_rational32 : uint -> sint ptr -> uint ptr -> term_t ptr -> term_t
  val yices_poly_rational64 : uint -> long ptr -> ulong ptr -> term_t ptr -> term_t
   ...
   *   code = ARITHTERM_REQUIRED
   *   term1 = t1 or t2 *)
  val yices_arith_eq_atom : term_t -> term_t -> term_t
  val yices_arith_neq_atom : term_t -> term_t -> term_t
  val yices_arith_geq_atom : term_t -> term_t -> term_t
  val yices_arith_leq_atom : term_t -> term_t -> term_t
  val yices_arith_gt_atom : term_t -> term_t -> term_t
  val yices_arith_lt_atom : term_t -> term_t -> term_t
   ...
   *   term1 = t *)
  val yices_arith_eq0_atom : term_t -> term_t
  val yices_arith_neq0_atom : term_t -> term_t
  val yices_arith_geq0_atom : term_t -> term_t
  val yices_arith_leq0_atom : term_t -> term_t
  val yices_arith_gt0_atom : term_t -> term_t
  val yices_arith_lt0_atom : term_t -> term_t
   ...
   *    code = MAX_BVSIZE_EXCEEDED
   *    badval = n *)
  val yices_bvconst_uint32 : uint -> uint -> term_t
  val yices_bvconst_uint64 : uint -> ulong -> term_t
  val yices_bvconst_int32 : uint -> sint -> term_t
  val yices_bvconst_int64 : uint -> long -> term_t
   ...
   *    code = MAX_BVSIZE_EXCEEDED
   *    badval = n *)
  val yices_bvconst_zero : uint -> term_t
  val yices_bvconst_one : uint -> term_t
  val yices_bvconst_minus_one : uint -> term_t
   ...
   *    code = MAX_BVSIZE_EXCEEDED
   *    badval = n *)
  val yices_bvconst_from_array : uint -> sint ptr -> term_t
   ...
   *   code = MAX_BVSIZE_EXCEEDED
   *   badval = n *)
  val yices_parse_bvbin : char ptr -> term_t
   ...
   *   code = MAX_BVSIZE_EXCEEDED
   *   badval = 4n *)
  val yices_parse_bvhex : char ptr -> term_t
   ...
   * *)
  val yices_bvadd : term_t -> term_t -> term_t
  val yices_bvsub : term_t -> term_t -> term_t
  val yices_bvneg : term_t -> term_t
  val yices_bvmul : term_t -> term_t -> term_t
  val yices_bvsquare : term_t -> term_t
  val yices_bvpower : term_t -> uint -> term_t
  val yices_bvdiv  : term_t -> term_t -> term_t
  val yices_bvrem  : term_t -> term_t -> term_t
  val yices_bvsdiv : term_t -> term_t -> term_t
  val yices_bvsrem : term_t -> term_t -> term_t
  val yices_bvsmod : term_t -> term_t -> term_t
  val yices_bvnot  : term_t -> term_t
  val yices_bvnand : term_t -> term_t -> term_t
  val yices_bvnor  : term_t -> term_t -> term_t
  val yices_bvxnor : term_t -> term_t -> term_t
  val yices_bvshl  : term_t -> term_t -> term_t
  val yices_bvlshr : term_t -> term_t -> term_t
  val yices_bvashr : term_t -> term_t -> term_t
   ...
   *    type2 = type of t[i]
   * *)
  val yices_bvand  : uint -> term_t ptr -> term_t
  val yices_bvor   : uint -> term_t ptr -> term_t
  val yices_bvxor  : uint -> term_t ptr -> term_t
  val yices_bvand2 : term_t -> term_t -> term_t
  val yices_bvor2  : term_t -> term_t -> term_t
  val yices_bvxor2 : term_t -> term_t -> term_t
  val yices_bvand3 : term_t -> term_t -> term_t -> term_t
  val yices_bvor3  : term_t -> term_t -> term_t -> term_t
  val yices_bvxor3 : term_t -> term_t -> term_t -> term_t
   ...
   *    term2 = t[i]
   *    type2 = type of t[i] *)
  val yices_bvsum  : uint -> term_t ptr -> term_t
   ...
   *    code = DEGREE_OVERFLOW
   *    badval = degree *)
  val yices_bvproduct : uint -> term_t ptr -> term_t
   ...
   *   badval = n *)
  val yices_shift_left0  : term_t -> uint -> term_t
  val yices_shift_left1  : term_t -> uint -> term_t
  val yices_shift_right0 : term_t -> uint -> term_t
  val yices_shift_right1 : term_t -> uint -> term_t
  val yices_ashift_right : term_t -> uint -> term_t
  val yices_rotate_left  : term_t -> uint -> term_t
  val yices_rotate_right : term_t -> uint -> term_t
  ...
  val yices_bvextract : term_t -> uint -> uint -> term_t
  ...
  val yices_bvconcat2 : term_t -> term_t -> term_t
  ...
  val yices_bvconcat : uint -> term_t ptr -> term_t
   ...
   *   code = MAX_BVSIZE_EXCEEDED
   *   badval = n * size of t *)
  val yices_bvrepeat : term_t -> uint -> term_t
   ...
   *   code = MAX_BVSIZE_EXCEEDED
   *   badval = n * size of t *)
  val yices_sign_extend : term_t -> uint -> term_t
   ...
   *   code = MAX_BVSIZE_EXCEEDED
   *   badval = n * size of t *)
  val yices_zero_extend : term_t -> uint -> term_t
   ...
   *   code = BITVECTOR_REQUIRED
   *   term1 = t *)
  val yices_redand : term_t -> term_t
  val yices_redor : term_t -> term_t
   ...
   *   term2 = t2
   *   type2 = type of t2 *)
  val yices_redcomp : term_t -> term_t -> term_t
   ...
   *    term1 = arg[i]
   *    type1 = bool *)
  val yices_bvarray : uint -> term_t ptr -> term_t
  ...
  val yices_bitextract : term_t -> uint -> term_t
  ...
  val yices_bveq_atom : term_t -> term_t -> term_t
  val yices_bvneq_atom : term_t -> term_t -> term_t

  (* Unsigned inequalities *)
  val yices_bvge_atom : term_t -> term_t -> term_t
  val yices_bvgt_atom : term_t -> term_t -> term_t
  val yices_bvle_atom : term_t -> term_t -> term_t
  val yices_bvlt_atom : term_t -> term_t -> term_t

  (* Signed inequalities *)
  val yices_bvsge_atom : term_t -> term_t -> term_t
  val yices_bvsgt_atom : term_t -> term_t -> term_t
  val yices_bvsle_atom : term_t -> term_t -> term_t
  val yices_bvslt_atom : term_t -> term_t -> term_t
  ...
  val yices_parse_type : char ptr -> type_t
  val yices_parse_term : char ptr -> term_t
  ...
  val yices_subst_term : uint -> term_t ptr -> term_t ptr -> term_t -> term_t
  ...
  val yices_subst_term_array :
    uint -> term_t ptr -> term_t ptr -> uint -> term_t ptr -> term_t
  ...
  val yices_get_type_by_name : char ptr -> type_t
  val yices_get_term_by_name : char ptr -> term_t
  ...
  val yices_get_type_name : type_t -> char ptr
  val yices_get_term_name : term_t -> char ptr
   ...
   *   code = INVALID_TERM
   *   term1 = t *)
  val yices_type_of_term : term_t -> type_t
   ...
   *    code = BITVECTOR_REQUIRED
   *    term1 = t *)
  val yices_term_bitsize : term_t -> uint
   ...
   *    code = INVALID_TERM
   *    term1 = t *)
  val yices_term_constructor : term_t -> term_constructor_t
  ...
  val yices_term_num_children : term_t -> sint
  ...
  val yices_term_child : term_t -> sint -> term_t
   ...
   *    code = INVALID_TERM_OP *)
  val yices_proj_index : term_t -> sint
  val yices_proj_arg : term_t -> term_t
  ...
  val yices_new_config  : unit -> ctx_config_t ptr
  ...
  val yices_new_context    : ctx_config_t ptr -> context_t ptr
  ...
  val yices_new_param_record : unit -> param_t ptr
  ...
  val yices_get_model : context_t ptr -> sint -> model_t ptr
  ...
  val yices_model_from_map : uint -> term_t ptr -> term_t ptr -> model_t ptr
  ...
  val yices_get_bool_value : model_t ptr -> term_t -> sint ptr -> sint
   ...
   *   code = EVAL_OVERFLOW *)
  val yices_get_int32_value : model_t ptr -> term_t -> sint ptr -> sint
  val yices_get_int64_value : model_t ptr -> term_t -> long ptr -> sint
  val yices_get_rational32_value : model_t ptr -> term_t -> sint ptr -> uint ptr -> sint
  val yices_get_rational64_value : model_t ptr -> term_t -> long ptr -> ulong ptr -> sint
  val yices_get_double_value : model_t ptr -> term_t -> float ptr -> sint
   ...
   *   code = BITVECTOR_REQUIRED
   *   term1 = t *)
  val yices_get_bv_value : model_t ptr -> term_t -> sint ptr -> sint
   ...
   *   term1 = t *)
  val yices_get_scalar_value : model_t ptr -> term_t -> sint ptr -> sint
  ...
  val yices_val_bitsize : model_t ptr -> yval_t ptr -> uint
  val yices_val_tuple_arity : model_t ptr -> yval_t ptr -> uint
  val yices_val_mapping_arity : model_t ptr -> yval_t ptr -> uint
  ...
  val yices_val_function_arity : model_t ptr -> yval_t ptr -> uint
   ...
   * *)   
  val yices_get_value_as_term : model_t ptr -> term_t -> term_t
   ...
   *    term1 = t
   * *)
  val yices_type_to_string : type_t -> uint -> uint -> uint -> char ptr
  val yices_term_to_string : term_t -> uint -> uint -> uint -> char ptr
  ...
  val yices_model_to_string : model_t ptr -> uint -> uint -> uint -> char ptr
end
