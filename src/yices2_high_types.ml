...
module type High = sig
  ...
  module Term : sig
    ...
    val subst_term_array : (term_t*term_t) list -> term_t list -> term_t eh
  ...
  module Model : sig
    ...
    *)
    ...
    val term_array_value : model_t ptr -> term_t list -> term_t list eh
    ...
    val generalize_model_array : model_t ptr -> term_t list -> term_t list -> yices_gen_mode -> term_t list eh
  ...
  module PP : sig
    ...
    val type_file : FILE.t ptr -> type_t -> width:int -> height:int -> offset:int -> unit eh
    val term_file : FILE.t ptr -> term_t -> width:int -> height:int -> offset:int -> unit eh
    ...
    (** Pretty print an array of terms:
        ...
        *)
    val term_array_file :
      FILE.t ptr -> term_t list -> width:int -> height:int -> offset:int -> layout:bool -> unit eh
    ...
    (** Pretty printing:
        ...
        On error:
         ...
         in this case, errno, perror, etc. can be used for diagnostic.  *)
    val model_file :
      FILE.t ptr -> ?width:int -> ?height:int -> ?offset:int -> model_t ptr -> unit eh
    ...
    val type_fd : sint -> type_t -> width:int -> height:int -> offset:int -> unit eh
    val term_fd : sint -> term_t -> width:int -> height:int -> offset:int -> unit eh
    val term_array_fd : sint -> term_t list -> width:int -> height:int -> offset:int -> layout:bool -> unit eh
    val model_fd : sint -> ?width:int -> ?height:int -> ?offset:int -> model_t ptr -> unit eh
    ...
    val type_string : type_t -> width:int -> height:int -> offset:int -> string eh
    val term_string : term_t -> width:int -> height:int -> offset:int -> string eh
    ...
    val model_string : model_t ptr -> width:int -> height:int -> offset:int -> string eh
  end
end
