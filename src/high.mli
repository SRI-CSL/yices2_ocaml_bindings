...
module Term : sig
   ...
   *    code = INVALID_TERM_OP *)
  val bool_const_value : term_t -> sint ptr -> sint
  val bv_const_value : term_t -> sint ptr -> sint
  val scalar_const_value : term_t -> sint ptr -> sint
...
module GC : sig
  ...
  val incref_term : term_t -> sint
  val decref_term : term_t -> sint
  val incref_type : type_t -> sint
  val decref_type : type_t -> sint
...
module Model : sig
  ...
  val get_bool_value : model_t ptr -> term_t -> sint ptr -> bool
  ...
  val init_yval_vector : yval_vector_t ptr -> unit
  val delete_yval_vector : yval_vector_t ptr -> unit
  val reset_yval_vector : yval_vector_t ptr -> unit
   ...
   * If the evaluation fails for other reasons:
   *   code = EVAL_FAILED *)
  val get_value : model_t ptr -> term_t -> yval_t ptr -> sint
   ...
   * object v. *)
  val val_function_type : model_t ptr -> yval_t ptr -> sint
   ...
   *   to YVAL_INVALID_OP. *)
  val val_get_bool : model_t ptr -> yval_t ptr -> sint ptr -> sint
   ...
   * ( *val ) or in ( *num )/( *den ). *)
  val val_get_int32 : model_t ptr -> yval_t ptr -> sint ptr -> sint
  val val_get_int64 : model_t ptr -> yval_t ptr -> long ptr -> sint
  val val_get_rational32 : model_t ptr -> yval_t ptr -> sint ptr -> uint ptr -> sint
  val val_get_rational64 : model_t ptr -> yval_t ptr -> long ptr -> ulong ptr -> sint

  (* Value converted to a floating point number *)
  val val_get_double : model_t ptr -> yval_t ptr -> float ptr -> sint
  ...
  val val_get_bv : model_t ptr -> yval_t ptr -> sint ptr -> sint
  ...
  val val_get_scalar : model_t ptr -> yval_t ptr -> sint ptr -> sint ptr -> sint
  ...
  val val_expand_tuple : model_t ptr -> yval_t ptr -> yval_t ptr -> sint
   ...
   * Return code = -1 otherwise and the error code is then set to YVAL_INVALID_OP. *)
  val val_expand_function : model_t ptr -> yval_t ptr -> yval_t ptr -> yval_vector_t ptr -> sint
   ...
   * Return code = -1 otherwise and the error code is then set to YVAL_INVALID_OP. *)
  val val_expand_mapping : model_t ptr -> yval_t ptr -> yval_t ptr -> yval_t ptr -> sint
  ...
  val formula_true_in_model : model_t ptr -> term_t -> sint
  ...
  val formulas_true_in_model : model_t ptr -> uint -> term_t ptr -> sint
  ...
  val term_array_value : model_t ptr -> uint -> term_t ptr -> term_t ptr -> sint
   ...
   *   EVAL_LAMBDA
   *   EVAL_FAILED *)
  val implicant_for_formula : model_t ptr -> term_t -> term_vector_t ptr -> sint
  ...
  val implicant_for_formulas : model_t ptr -> uint -> term_t ptr -> term_vector_t ptr -> sint
