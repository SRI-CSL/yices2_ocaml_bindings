    ...
    let rename =
      Foreign.foreign "rename"
        (Ctypes.(@->) (Ctypes.ptr Ctypes.char)
           (Ctypes.(@->) (Ctypes.ptr Ctypes.char)
              (Ctypes.returning Ctypes.sint)))
    let renameat =
      Foreign.foreign "renameat"
        (Ctypes.(@->) Ctypes.sint
           (Ctypes.(@->) (Ctypes.ptr Ctypes.char)
              (Ctypes.(@->) Ctypes.sint
                 (Ctypes.(@->) (Ctypes.ptr Ctypes.char)
                    (Ctypes.returning Ctypes.sint)))))
    let tmpfile =
      Foreign.foreign "tmpfile"
        (Ctypes.(@->) Ctypes.void (Ctypes.returning (Ctypes.ptr _FILE)))
    let tmpnam =
      ...
      Foreign.foreign "tempnam"
        (Ctypes.(@->) (Ctypes.ptr Ctypes.char)
           (Ctypes.(@->) (Ctypes.ptr Ctypes.char)
              (Ctypes.returning (Ctypes.ptr Ctypes.char))))
    let fclose =
      Foreign.foreign "fclose"
        (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning Ctypes.sint))
    let fflush =
      Foreign.foreign "fflush"
        (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning Ctypes.sint))
    let fflush_unlocked =
      Foreign.foreign "fflush_unlocked"
        (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning Ctypes.sint))
    let fopen =
      Foreign.foreign "fopen"
        (Ctypes.(@->) (Ctypes.ptr Ctypes.char)
           (Ctypes.(@->) (Ctypes.ptr Ctypes.char)
              (Ctypes.returning (Ctypes.ptr _FILE))))
    let freopen =
      Foreign.foreign "freopen"
        (Ctypes.(@->) (Ctypes.ptr Ctypes.char)
           (Ctypes.(@->) (Ctypes.ptr Ctypes.char)
              (Ctypes.(@->) (Ctypes.ptr _FILE)
                 (Ctypes.returning (Ctypes.ptr _FILE)))))
    let fdopen =
      Foreign.foreign "fdopen"
        (Ctypes.(@->) Ctypes.sint
           (Ctypes.(@->) (Ctypes.ptr Ctypes.char)
              (Ctypes.returning (Ctypes.ptr _FILE))))
    let fmemopen =
      Foreign.foreign "fmemopen"
        (Ctypes.(@->) (Ctypes.ptr Ctypes.void)
           (Ctypes.(@->) size_t
              (Ctypes.(@->) (Ctypes.ptr Ctypes.char)
                 (Ctypes.returning (Ctypes.ptr _FILE)))))
    let open_memstream =
      Foreign.foreign "open_memstream"
        (Ctypes.(@->) (Ctypes.ptr (Ctypes.ptr Ctypes.char))
           (Ctypes.(@->) (Ctypes.ptr size_t)
              (Ctypes.returning (Ctypes.ptr _FILE))))
    let setbuf =
      Foreign.foreign "setbuf"
        (Ctypes.(@->) (Ctypes.ptr _FILE)
           (Ctypes.(@->) (Ctypes.ptr Ctypes.char)
              (Ctypes.returning Ctypes.void)))
    let setvbuf =
      Foreign.foreign "setvbuf"
        (Ctypes.(@->) (Ctypes.ptr _FILE)
           (Ctypes.(@->) (Ctypes.ptr Ctypes.char)
              (Ctypes.(@->) Ctypes.sint
                 (Ctypes.(@->) size_t (Ctypes.returning Ctypes.sint)))))
    let setbuffer =
      Foreign.foreign "setbuffer"
        (Ctypes.(@->) (Ctypes.ptr _FILE)
           (Ctypes.(@->) (Ctypes.ptr Ctypes.char)
              (Ctypes.(@->) size_t (Ctypes.returning Ctypes.void))))
    let setlinebuf =
      Foreign.foreign "setlinebuf"
        (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning Ctypes.void))
    let fprintf =
      Foreign.foreign "fprintf"
        (Ctypes.(@->) (Ctypes.ptr _FILE)
           (Ctypes.(@->) (Ctypes.ptr Ctypes.char)
              (Ctypes.returning Ctypes.sint)))
    let printf =
      Foreign.foreign "printf"
        (Ctypes.(@->) (Ctypes.ptr Ctypes.char) (Ctypes.returning Ctypes.sint))
    let sprintf =
      Foreign.foreign "sprintf"
        (Ctypes.(@->) (Ctypes.ptr Ctypes.char)
           (Ctypes.(@->) (Ctypes.ptr Ctypes.char)
              (Ctypes.returning Ctypes.sint)))
    let snprintf =
      Foreign.foreign "snprintf"
        (Ctypes.(@->) (Ctypes.ptr Ctypes.char)
           (Ctypes.(@->) size_t
              (Ctypes.(@->) (Ctypes.ptr Ctypes.char)
                 (Ctypes.returning Ctypes.sint))))
    let dprintf =
      Foreign.foreign "dprintf"
        (Ctypes.(@->) Ctypes.sint
           (Ctypes.(@->) (Ctypes.ptr Ctypes.char)
              (Ctypes.returning Ctypes.sint)))
    let fscanf =
      Foreign.foreign "fscanf"
        (Ctypes.(@->) (Ctypes.ptr _FILE)
           (Ctypes.(@->) (Ctypes.ptr Ctypes.char)
              (Ctypes.returning Ctypes.sint)))
    let scanf =
      Foreign.foreign "scanf"
        (Ctypes.(@->) (Ctypes.ptr Ctypes.char) (Ctypes.returning Ctypes.sint))
    let sscanf =
      Foreign.foreign "sscanf"
        (Ctypes.(@->) (Ctypes.ptr Ctypes.char)
           (Ctypes.(@->) (Ctypes.ptr Ctypes.char)
              (Ctypes.returning Ctypes.sint)))
    let fscanf_0 =
      ...
      Foreign.foreign "sscanf"
        (Ctypes.(@->) (Ctypes.ptr Ctypes.char)
           (Ctypes.(@->) (Ctypes.ptr Ctypes.char)
              (Ctypes.returning Ctypes.sint)))
    let fgetc =
      Foreign.foreign "fgetc"
        (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning Ctypes.sint))
    let getc =
      Foreign.foreign "getc"
        (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning Ctypes.sint))
    let getchar =
      Foreign.foreign "getchar"
        (Ctypes.(@->) Ctypes.void (Ctypes.returning Ctypes.sint))
    let getc_unlocked =
      Foreign.foreign "getc_unlocked"
        (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning Ctypes.sint))
    let getchar_unlocked =
      Foreign.foreign "getchar_unlocked"
        (Ctypes.(@->) Ctypes.void (Ctypes.returning Ctypes.sint))
    let fgetc_unlocked =
      Foreign.foreign "fgetc_unlocked"
        (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning Ctypes.sint))
    let fputc =
      Foreign.foreign "fputc"
        (Ctypes.(@->) Ctypes.sint
           (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning Ctypes.sint)))
    let putc =
      Foreign.foreign "putc"
        (Ctypes.(@->) Ctypes.sint
           (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning Ctypes.sint)))
    let putchar =
      Foreign.foreign "putchar"
        (Ctypes.(@->) Ctypes.sint (Ctypes.returning Ctypes.sint))
    let fputc_unlocked =
      Foreign.foreign "fputc_unlocked"
        (Ctypes.(@->) Ctypes.sint
           (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning Ctypes.sint)))
    let putc_unlocked =
      Foreign.foreign "putc_unlocked"
        (Ctypes.(@->) Ctypes.sint
           (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning Ctypes.sint)))
    let putchar_unlocked =
      Foreign.foreign "putchar_unlocked"
        (Ctypes.(@->) Ctypes.sint (Ctypes.returning Ctypes.sint))
    let getw =
      Foreign.foreign "getw"
        (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning Ctypes.sint))
    let putw =
      Foreign.foreign "putw"
        (Ctypes.(@->) Ctypes.sint
           (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning Ctypes.sint)))
    let fgets =
      Foreign.foreign "fgets"
        (Ctypes.(@->) (Ctypes.ptr Ctypes.char)
           (Ctypes.(@->) Ctypes.sint
              (Ctypes.(@->) (Ctypes.ptr _FILE)
                 (Ctypes.returning (Ctypes.ptr Ctypes.char)))))
    let __getdelim =
      Foreign.foreign "__getdelim"
        (Ctypes.(@->) (Ctypes.ptr (Ctypes.ptr Ctypes.char))
           (Ctypes.(@->) (Ctypes.ptr size_t)
              (Ctypes.(@->) Ctypes.sint
                 (Ctypes.(@->) (Ctypes.ptr _FILE)
                    (Ctypes.returning __ssize_t)))))
    let getdelim =
      Foreign.foreign "getdelim"
        (Ctypes.(@->) (Ctypes.ptr (Ctypes.ptr Ctypes.char))
           (Ctypes.(@->) (Ctypes.ptr size_t)
              (Ctypes.(@->) Ctypes.sint
                 (Ctypes.(@->) (Ctypes.ptr _FILE)
                    (Ctypes.returning __ssize_t)))))
    let getline =
      Foreign.foreign "getline"
        (Ctypes.(@->) (Ctypes.ptr (Ctypes.ptr Ctypes.char))
           (Ctypes.(@->) (Ctypes.ptr size_t)
              (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning __ssize_t))))
    let fputs =
      Foreign.foreign "fputs"
        (Ctypes.(@->) (Ctypes.ptr Ctypes.char)
           (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning Ctypes.sint)))
    let puts =
      Foreign.foreign "puts"
        (Ctypes.(@->) (Ctypes.ptr Ctypes.char) (Ctypes.returning Ctypes.sint))
    let ungetc =
      Foreign.foreign "ungetc"
        (Ctypes.(@->) Ctypes.sint
           (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning Ctypes.sint)))
    let fread =
      Foreign.foreign "fread"
        (Ctypes.(@->) (Ctypes.ptr Ctypes.void)
           (Ctypes.(@->) size_t
              (Ctypes.(@->) size_t
                 (Ctypes.(@->) (Ctypes.ptr _FILE)
                    (Ctypes.returning Ctypes.ulong)))))
    let fwrite =
      Foreign.foreign "fwrite"
        (Ctypes.(@->) (Ctypes.ptr Ctypes.void)
           (Ctypes.(@->) size_t
              (Ctypes.(@->) size_t
                 (Ctypes.(@->) (Ctypes.ptr _FILE)
                    (Ctypes.returning Ctypes.ulong)))))
    let fread_unlocked =
      Foreign.foreign "fread_unlocked"
        (Ctypes.(@->) (Ctypes.ptr Ctypes.void)
           (Ctypes.(@->) size_t
              (Ctypes.(@->) size_t
                 (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning size_t)))))
    let fwrite_unlocked =
      Foreign.foreign "fwrite_unlocked"
        (Ctypes.(@->) (Ctypes.ptr Ctypes.void)
           (Ctypes.(@->) size_t
              (Ctypes.(@->) size_t
                 (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning size_t)))))
    let fseek =
      Foreign.foreign "fseek"
        (Ctypes.(@->) (Ctypes.ptr _FILE)
           (Ctypes.(@->) Ctypes.long
              (Ctypes.(@->) Ctypes.sint (Ctypes.returning Ctypes.sint))))
    let ftell =
      Foreign.foreign "ftell"
        (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning Ctypes.long))
    let rewind =
      Foreign.foreign "rewind"
        (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning Ctypes.void))
    let fseeko =
      Foreign.foreign "fseeko"
        (Ctypes.(@->) (Ctypes.ptr _FILE)
           (Ctypes.(@->) __off_t
              (Ctypes.(@->) Ctypes.sint (Ctypes.returning Ctypes.sint))))
    let ftello =
      Foreign.foreign "ftello"
        (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning __off_t))
    let fgetpos =
      Foreign.foreign "fgetpos"
        (Ctypes.(@->) (Ctypes.ptr _FILE)
           (Ctypes.(@->) (Ctypes.ptr fpos_t) (Ctypes.returning Ctypes.sint)))
    let fsetpos =
      Foreign.foreign "fsetpos"
        (Ctypes.(@->) (Ctypes.ptr _FILE)
           (Ctypes.(@->) (Ctypes.ptr fpos_t) (Ctypes.returning Ctypes.sint)))
    let clearerr =
      Foreign.foreign "clearerr"
        (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning Ctypes.void))
    let feof =
      Foreign.foreign "feof"
        (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning Ctypes.sint))
    let ferror =
      Foreign.foreign "ferror"
        (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning Ctypes.sint))
    let clearerr_unlocked =
      Foreign.foreign "clearerr_unlocked"
        (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning Ctypes.void))
    let feof_unlocked =
      Foreign.foreign "feof_unlocked"
        (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning Ctypes.sint))
    let ferror_unlocked =
      Foreign.foreign "ferror_unlocked"
        (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning Ctypes.sint))
    let perror =
      Foreign.foreign "perror"
        (Ctypes.(@->) (Ctypes.ptr Ctypes.char) (Ctypes.returning Ctypes.void))
    let sys_nerr = Foreign.foreign_value "sys_nerr" Ctypes.sint
    let sys_errlist =
      Foreign.foreign_value "sys_errlist"
        (Ctypes.ptr (Ctypes.ptr Ctypes.char))
    let fileno =
      Foreign.foreign "fileno"
        (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning Ctypes.sint))
    let fileno_unlocked =
      Foreign.foreign "fileno_unlocked"
        (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning Ctypes.sint))
    let popen =
      Foreign.foreign "popen"
        (Ctypes.(@->) (Ctypes.ptr Ctypes.char)
           (Ctypes.(@->) (Ctypes.ptr Ctypes.char)
              (Ctypes.returning (Ctypes.ptr _FILE))))
    let pclose =
      Foreign.foreign "pclose"
        (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning Ctypes.sint))
    let ctermid =
      Foreign.foreign "ctermid"
        (Ctypes.(@->) (Ctypes.ptr Ctypes.char)
           (Ctypes.returning (Ctypes.ptr Ctypes.char)))
    let flockfile =
      Foreign.foreign "flockfile"
        (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning Ctypes.void))
    let ftrylockfile =
      Foreign.foreign "ftrylockfile"
        (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning Ctypes.sint))
    let funlockfile =
      Foreign.foreign "funlockfile"
        (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning Ctypes.void))
    let __uflow =
      Foreign.foreign "__uflow"
        (Ctypes.(@->) (Ctypes.ptr _FILE) (Ctypes.returning Ctypes.sint))
    let __overflow =
      Foreign.foreign "__overflow"
        (Ctypes.(@->) (Ctypes.ptr _FILE)
           (Ctypes.(@->) Ctypes.sint (Ctypes.returning Ctypes.sint)))
